let game; // switch Game On or OFF
let score; // Score
let arr = []; // shuffle Numbers To Get Random Question without Repeating
var nb; // Create Number
let Quest = []; // Question = [nb]
/*------------Elements---------------*/
const boxAccueil = document.getElementById('accueil')
const boxFin = document.getElementById('fin')
boxFin.classList.add('hide') // add Class
...
boxContainer.classList.add('hide') // add Class
const startButton = document.getElementById('btnStart')
const eltBtn = document.querySelector('.btn')
/*------------Start_The_Game-----------*/
startButton.addEventListener('click', startGame)
// Read Question Answer and Button
...
const hidenext = eltBtnNext.classList.remove('hide') // remove Class 
